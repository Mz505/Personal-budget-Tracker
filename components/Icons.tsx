...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.25 8.25 0 0 1 5.72 5.72c.046.55-.327 1.02-.962 1.11l-.096.018-1.518.254a2.25 2.25 0 0 0-1.523 1.523l-.254 1.518-.018.096c-.09.542-.56 1.007-1.11.962a8.25 8.25 0 0 1-5.72-5.72c-.046-.55.327-1.02.962-1.11l.096-.018 1.518-.254a2.25 2.25 0 0 0 1.523-1.523l.254-1.518.018-.096ZM12 9.75a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z" />
...
export const BanknotesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75-.75v-.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V6.75c0-.621.504-1.125 1.125-1.125h16.5c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-16.5a1.125 1.125 0 0 1-1.125-1.125v-9.75A1.125 1.125 0 0 1 3.75 6h.375M3.75 6v-.75A.75.75 0 0 0 3 4.5h-.75m0 0v.375c0 .621-.504 1.125-1.125 1.125H.75m19.5 0v.75c0 .414-.336.75-.75.75h-.75m1.5-1.5h-.375a1.125 1.125 0 0 0-1.125 1.125v9.75c0 .621.504 1.125 1.125 1.125h.375m-1.5-1.5H21a.75.75 0 0 1 .75.75v.75m0 0h-3.75m0 0h-3.75m0 0h-3.75m0 0h-3.75M9 12v6.375m3-6.375v6.375m3-6.375v6.375M3.75 6.75h16.5" />
    </svg>
);
...
export const ChatBubbleOvalLeftEllipsisIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-.388m-5.182-2.262a2.25 2.25 0 0 1-2.242-2.242V6.102a2.25 2.25 0 0 1 2.242-2.242m5.182 10.536h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm3.183-4.402h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm3.183-4.393h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm-3.183 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Zm0 0h.008.008v-.008h-.008v.008Z" />
    </svg>
);
